...
public class Security_ADD_MOD_DEL {
	int X;
	int Y;
   JButton jbtn1;
   JButton jbtn2;
   ...
   public Security_ADD_MOD_DEL(int X, int Y){ 
	   this.X=X;
	   this.Y=Y;
	   jbtn1=new JButton("Add Security");
	   jbtn2=new JButton("Delete Security");
	   jbtn3=new JButton("Modify Security");
	   jlblpgn=new JLabel();
	   y=new JFrame();
