...
public class Transporter_ADD_MOD_DEL {
	int X;
	int Y;
   JButton jbtn1;
   JButton jbtn2;
   ...
   public Transporter_ADD_MOD_DEL(int X, int Y){ 
	   this.X=X;
	   this.Y=Y;
	   jbtn1=new JButton("Add Transporter");
	   jbtn2=new JButton("Delete Transporter");
	   jbtn3=new JButton("Modify Transporter");
	   jlblpgn=new JLabel();
	   y=new JFrame();
	   
       y.setLayout(null);
       y.getContentPane().setBackground(Color.CYAN);
       y.setTitle("Transporter");
