...
public class RoomCleaner_ADD_MOD_DEL {
	int X;
	int Y;
   JButton jbtn1;
   JButton jbtn2;
   ...
   public RoomCleaner_ADD_MOD_DEL(int X, int Y){ 
	   this.X=X;
	   this.Y=Y;
	   jbtn1=new JButton("Add RoomCleaner");
	   jbtn2=new JButton("Delete RoomCleaner");
	   jbtn3=new JButton("Modify RoomCleaner");
	   jlblpgn=new JLabel();
	   y=new JFrame();
	   
       y.setLayout(null);
       y.getContentPane().setBackground(Color.CYAN);
       y.setTitle("RoomCleaner");
